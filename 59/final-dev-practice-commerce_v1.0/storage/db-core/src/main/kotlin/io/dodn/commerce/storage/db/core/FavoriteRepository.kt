...
interface FavoriteRepository : JpaRepository<FavoriteEntity, Long> {
    ...
    fun findByUserIdAndStatusAndTargetTypeAndUpdatedAtAfter(userId: Long, status: EntityStatus, targetType: FavoriteTargetType, updatedAtAfter: LocalDateTime, pageable: Pageable): Slice<FavoriteEntity>
