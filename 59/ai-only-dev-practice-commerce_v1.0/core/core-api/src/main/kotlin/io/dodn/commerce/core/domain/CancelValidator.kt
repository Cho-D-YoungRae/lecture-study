...
class CancelValidator(
    ...
    fun validate(user: User, orderKey: String) {
    ...
    fun validatePartial(user: User, orderKey: String, orderItemId: Long, quantity: Long) {
        ...
        if (targetItem.cancellableQuantity() < quantity) {
