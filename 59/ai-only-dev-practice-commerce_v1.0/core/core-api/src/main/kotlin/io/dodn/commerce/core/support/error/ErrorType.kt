...
enum class ErrorType(val status: HttpStatus, val code: ErrorCode, val message: String, val logLevel: LogLevel) {
    ...
    // 공유 장바구니
    SHARED_CART_NOT_FOUND_OR_DELETED(HttpStatus.BAD_REQUEST, ErrorCode.E8000, "공유 장바구니를 찾을 수 없거나 삭제되었습니다.", LogLevel.INFO),
    SHARED_CART_EXPIRED(HttpStatus.BAD_REQUEST, ErrorCode.E8001, "공유 장바구니가 만료되어 상품을 추가할 수 없습니다.", LogLevel.INFO),
}
