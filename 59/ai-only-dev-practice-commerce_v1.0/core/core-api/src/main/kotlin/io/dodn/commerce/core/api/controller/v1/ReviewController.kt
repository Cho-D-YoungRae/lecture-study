...
class ReviewController(
    ...
    fun createReview(
        ...
        reviewService.addReview(user, request.toTarget(), request.toContent(), request.toImages())
    ...
    fun updateReview(
        ...
        reviewService.updateReview(user, reviewId, request.toContent(), request.toImages(), request.toDeleteImageIds())
        return ApiResponse.success()
    }
