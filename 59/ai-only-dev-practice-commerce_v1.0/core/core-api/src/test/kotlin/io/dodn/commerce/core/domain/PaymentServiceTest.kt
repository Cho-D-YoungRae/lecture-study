...
class PaymentServiceTest(
    ...
    fun `결제 성공 시 포인트 차감 및 적립과 히스토리가 기록된다`() {
        ...
        // order item updated
        val updatedOrderItem = orderItemRepository.findById(orderItem.id).orElseThrow()
        assertThat(updatedOrderItem.state).isEqualTo(OrderState.CREATED)
        ...
        assertThat(txs).anySatisfy {
            ...
            assertThat(it.paidAmount).isEqualByComparingTo(paidAmount)
        }
    }
}
