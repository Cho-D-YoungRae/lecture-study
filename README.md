...
58. [제미니의 개발실무 - 커머스 백엔드 기본편](./58) - `inflearn`, `제미니`
59. [제미니의 개발실무 - 커머스 백엔드 레거시와 AI 활용편](./59) - `inflearn`, `제미니`
60. [김영한의 실전 데이터베이스 - 설계 2편, 실무에서 반드시 마주치는 9가지 설계 패턴](./60) - `inflearn`, `김영한`
