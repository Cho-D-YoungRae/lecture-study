...
class QuerydslBasicTest {
    ...
    void sort() {
        ...
        assertThat(result.get(1).getUsername())
                .isEqualTo("member6");
        assertThat(result.get(2).getUsername())
                .isNull();
    }
    ...
    void paging2() {
        // queryFactory.fetchResults() -> deprecated 되어서 생략
    }
    ...
    void aggregation() {
        ...
        assertThat(tuple.get(member.count()))
                .isEqualTo(4);
        assertThat(tuple.get(member.age.sum()))
                .isEqualTo(100);
        assertThat(tuple.get(member.age.avg()))
                .isEqualTo(25);
        assertThat(tuple.get(member.age.max()))
                .isEqualTo(40);
        assertThat(tuple.get(member.age.min()))
                .isEqualTo(10);
    }
...
//                .innerJoin(member.team, team)
    ...
    /**
     * 세타 조인 -> 연관관계 없어도 join 가능하다. 세타 조인 혹은 on
    ...
    void findDtoByJpql() {
        List<MemberDto> result = em.createQuery(
                "select new study.querydsl2.dto.MemberDto(" +
                        "m.username, m.age)" +
                        " from Member m",
                MemberDto.class
        ).getResultList();
    ...
    private BooleanExpression usernameEq(String usernameCond) {
        return Objects.nonNull(usernameCond) ? member.username.eq(usernameCond) : null;
    }

    private BooleanExpression ageEq(Integer ageCond) {
        return Objects.nonNull(ageCond) ? member.age.eq(ageCond) : null;
    }
    ...
    void bulkUpdate() {
        ...
        assertThat(result)
                .extracting("username")
                .containsExactly("비회원", "비회원", "member3", "member4");
    }
